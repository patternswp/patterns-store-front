 ...
 * Slug: patterns-store-front/query-pattern-header
 * Categories: query
...
<!-- wp:navigation {"align":"wide","showSubmenuIcon":false,"overlayMenu":"never","style":{"spacing":{"blockGap":"var:preset|spacing|10"},"typography":{"fontSize":"13px"}}} /-->
...
<!-- wp:buttons {"style":{"spacing":{"blockGap":"var:preset|spacing|10"},"typography":{"fontSize":"13px"}}} -->
...
<div class="wp-block-button"><a class="wp-block-button__link has-quaternary-color has-quinary-background-color has-text-color has-background has-link-color wp-element-button" style="padding-top:6px;padding-right:12px;padding-bottom:6px;padding-left:12px"><?php esc_html_e( 'All', 'patterns-store-front' ); ?></a></div>
<!-- /wp:button -->
...
<div class="wp-block-button"><a class="wp-block-button__link has-quaternary-color has-quinary-background-color has-text-color has-background has-link-color wp-element-button" style="padding-top:6px;padding-right:12px;padding-bottom:6px;padding-left:12px"><?php esc_html_e( 'Pattern kits', 'patterns-store-front' ); ?></a></div>
<!-- /wp:button -->
...
<div class="wp-block-button"><a class="wp-block-button__link has-quaternary-color has-quinary-background-color has-text-color has-background has-link-color wp-element-button" style="padding-top:6px;padding-right:12px;padding-bottom:6px;padding-left:12px"><?php esc_html_e( 'Patterns', 'patterns-store-front' ); ?></a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons -->

<!-- wp:group {"layout":{"type":"flex","flexWrap":"nowrap","justifyContent":"space-between"}} -->
<div class="wp-block-group">
<!-- wp:patterns-store/query-total /-->
<!-- wp:search {"label":"<?php esc_attr_e( 'Search', 'patterns-store-front' ); ?>","showLabel":false,"placeholder":"<?php esc_attr_e( 'Search', 'patterns-store-front' ); ?>","buttonText":"<?php esc_attr_e( 'Search', 'patterns-store-front' ); ?>","buttonPosition":"no-button","buttonUseIcon":true} /--></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
<!-- /wp:group -->
