 ...
 * Slug: patterns-store-front/hidden-single-pattern-sidebar
 * Inserter: no
 *
...
<!-- wp:group {"metadata":{"name":"Card Body"},"align":"full","style":{"spacing":{"padding":{"top":"15px","bottom":"15px","left":"15px","right":"15px"}}},"layout":{"type":"default"}} -->
<div class="wp-block-group alignfull" style="padding-top:15px;padding-right:15px;padding-bottom:15px;padding-left:15px">
	<!-- wp:post-terms {"term":"pattern-category","separator":"","patterns-store-empty-text":"<?php esc_html_e( 'Categories not found.', 'patterns-store-front' ); ?>"} /-->
	</div>
<!-- /wp:group --></div>
<!-- /wp:group -->
...
<!-- wp:group {"metadata":{"name":"Card Body"},"align":"full","style":{"spacing":{"padding":{"top":"15px","bottom":"15px","left":"15px","right":"15px"}}},"layout":{"type":"default"}} -->
<div class="wp-block-group alignfull" style="padding-top:15px;padding-right:15px;padding-bottom:15px;padding-left:15px">
	<!-- wp:post-terms {"term":"pattern-tag","separator":"","patterns-store-empty-text":"<?php esc_html_e( 'Tags not found.', 'patterns-store-front' ); ?>"} /-->
</div>
<!-- /wp:group -->
</div>
<!-- /wp:group -->
